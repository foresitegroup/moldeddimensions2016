...
Pentathane&reg; is known for:<br>
<ul>
...
<h2>Outstanding Physical Properties</h2>
<ul>
  <li>Wide range of hardnesses</li>
  <li>High load-bearing capabilities</li>
  <li>High abrasion resistance</li>
  <li>Low coefficients of friction</li>
  <li>Good resistance to gas, oil, alkali and acid</li>
  <li>Tear resistance and toughness</li>
</ul>
<br>

The two main types of cast polyurethanes, Polyester and Polyether, offer specific properties:<br>
<br>

<img class="one-half-right" src="images/poly2.jpg" alt="Compression molded cast urethane parts.">
<strong>Ester</strong><br>
<ul>
  <li>Solvent, Oil and Fuel Resistance</li>
  <li>Abrasion resistance</li>
  <li>Excellent Mechanical Properties</li>
  <li>Dry heat resistance to 200F</li>
  <li>Vibration Dampening</li>
  <li>Higher Split Tear Strength</li>
</ul>
<br>

<strong>Ether</strong><br>
<ul>
  <li>Superior Rebound Properties</li>
  <li>Low Temperature Flexibility</li>
  <li>Excellent Hydrolytic Stability</li>
  <li>Excellent Mechanical Properties</li>
  <li>Resistance to Dynamic Heat</li>
  <li>Reduced frictional properties</li>
</ul>
<br>
...
<strong>vs Metal:</strong><br>
<ul>
  <li>Less weight</li>
  <li>Less Noise</li>
  <li>Better wear</li>
  <li>Corrosion resistance</li>
  <li>Cheaper fabrication</li>
  <li>Non-sparking</li>
...
<strong>vs Rubber:</strong><br>
<ul>
  <li>Abrasion resistance</li>
  <li>Cut and tear resistance</li>
  <li>Higher load bearing</li>
  <li>Harder durometer range</li>
  <li>Clarity, Translucence</li>
  <li>Non-marking, non- staining</li>
  <li>Pourable, castable</li>
  <li>Ozone resistance</li>
  <li>Micro organism resistance</li>
  <li>High dampening</li>
</ul>
<br>

<strong>vs Plastic:</strong><br>
<ul>
<li>Non-brittle</li>
<li>Abrasion resistance</li>
<li>High elongation</li>
<li>Elastomeric memory</li>
<li>Impact resistance</li>
<li>Lower tooling cost</li>
</ul>
<br>

<img class="one-half-right" src="images/poly4.jpg" alt="Insert prep for roller, mount, impellor, and gear applications.">
...
<h2>Insert Molding</h2>
When additional mechanical structure is needed in a component, cast urethane is easily overmolded onto a substrate. A variety of metals including carbon steel, aluminum, stainless, brass and bronze can be used. Non-metallic, rigid materials, such as fiberglass and glass-filled nylon, are also candidates.<br>
<br>

Urethane may be either mechanically or chemically bonded to an insert. Mechanical bond is the encapsulation of the substrate without the use of a secondary adhesive. A chemical bond utilizes an adhesive system to ensure an unyielding bond between the substrate and urethane.<br>
<br>
...
<ul>
  ...
  <li>Kitting - Products may be special packaged, labeled or assembled per customer requirements.</li>
  <li>Inventory Programs - Flexible systems, including KANBAN, are set up to hold raw, WIP and/or finished goods inventory depending on customer need.</li>
</ul>
<br>
