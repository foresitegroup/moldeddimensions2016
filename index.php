...
$CurrentMenu = "m1";
$PageTitle = "";
$Description = "The mission on Molded Dimensions is to provide engineered elastomer solutions that help our customers succeed.";
...
<div class="home-boxes">
  <div class="home-box cf">
    ...
    <a href="rubber-molding.php" class="hb-more">More</a>
  </div>
  ...
  <div class="home-box cf">
    ...
    <div class="hb-text">
      Cast polyurethane mechanical components are manufactured using open cast and compression molding technologies for a wide variety of applications and industries.
    </div>
    <a href="polyurethane-molding.php" class="hb-more">More</a>
  </div>
  ...
  <div class="home-box cf">
    ...
    <div class="hb-text">
      This business unit focuses on providing product from worldwide manufacturers, supported by MD's local technical expertise and project management.
    </div>
