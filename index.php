...
<div class="credibility">
  <div class="site-width">
    ...
    <ul class="cred-logos">
      <li><img alt="PMA's Regulatory Compliance Self-Certification Program Logo" src="images/logo-cred-pma-01.png"></li>
      <li><img alt="Bsi award logo" src="images/logo-cred-bsi-01.png"></li>
      <li><img alt="Milwaukee Journal Sentinel top place to work award logo" src="images/logo-cred-top-places-01.png"></li>
