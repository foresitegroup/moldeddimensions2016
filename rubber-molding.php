...
<img class="one-half-right" src="images/rubber-molding2.jpg" alt="Metal stems for bonding to SBR, EPDM, polychloroprene, Nitrile, or fluoroelastomers.">
<h2>Common Materials Processed</h2>
<ul>
  <li>Natural Rubber, NR</li>
  <li>Styrene-Butadiene, SBR</li>
  <li>Butyl, Isobutylene-isoprene, IIR</li>
  <li>Ethylene-propylene-diene, EPDM</li>
  <li>Polychloroprene, Neoprene&trade; ,CR</li>
  <li>Nitrile, Buna-N, Acrylonitrile Butadiene Rubber , NBR</li>
  <li>Silicone, Polysiloxane, VMQ</li>
  <li>Epichlorohydrin, Hydrin&trade;, ECO</li>
  <li>Fluoroelastomer, Viton&trade;, FKM</li>
  <li>Polyurethane, Millable, Polyester and Polyether based, EU</li>
  <li>Fluorosilicone, FVMQ</li>
</ul>
<br>
...
<ul>
  ...
  <li>Inventory Programs - Flexible systems, including KANBAN, are set up to hold raw, WIP and/or finished goods inventory domestically or abroad depending on customer need.</li>
</ul>
<br>
<br>
